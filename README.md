...
```bash
docker pull ghcr.io/adrianmross/matrix-construct:0.3.22
```
...
```bash
git tag -a v0.3.22 -m "Release v0.3.22"
...
with `version=0.3.22` after bumping the Cargo package versions. It validates
