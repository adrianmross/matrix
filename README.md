...
```bash
docker pull ghcr.io/adrianmross/matrix-construct:0.3.23
```
...
```bash
git tag -a v0.3.23 -m "Release v0.3.23"
...
with `version=0.3.23` after bumping the Cargo package versions. It validates
